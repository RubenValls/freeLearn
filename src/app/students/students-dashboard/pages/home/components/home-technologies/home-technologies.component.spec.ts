...
describe('HomeTechnologiesComponent', () => {
  ...
  it('should have 4 technologies after ngOnInit', () => {
    expect(component.techs?.length).toEqual(4);
  });

  it('should have random technologies after ngOnInit', () => {
    const technologyMock: TechnologyType[] = [
      {
        id: '1',
        name: 'Angular',
    ...
    storeMock.select.and.returnValue(of(technologyMock));
    component.ngOnInit();
    expect(component.techs).not.toEqual(technologyMock);
  });
});
